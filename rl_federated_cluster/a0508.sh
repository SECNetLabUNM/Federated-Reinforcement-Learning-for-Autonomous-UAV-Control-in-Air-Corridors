...
#param13_values=(0.075 0.1)  # num of future corridors in state, at least 1
param13_values=(0.1)  # num of future corridors in state, at least 1
...
#                        fi
                      ...
                      exp_name="new_net:${param1}_${param2}_${param3}_${param4}_${param6}_${param8}_${param9}_${param11}_${param12}_${param13}_${param16}_${param17}_${param18}_${param19}"
                      echo $PATH
