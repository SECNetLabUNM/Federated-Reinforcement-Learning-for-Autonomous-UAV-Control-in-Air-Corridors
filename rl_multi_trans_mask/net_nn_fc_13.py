...
class MergedModel(nn.Module):
    def __init__(self, s1_dim, s2_dim, net_width, with_position, token_query, num_enc, num_dec, logger=None):
        ...
        self.eb1 = BatchNormEmbedding(output_dim=net_width,hidden=128)
        self.eb2 = LayerNormEmbedding(output_dim=net_width)
        self.eb3 = LayerNormEmbedding(output_dim=net_width)
