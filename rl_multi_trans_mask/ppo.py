...
from rl_multi_3d_trans import (net_nn_fc_2, net_nn_fc_3, net_nn_fc_4,
                               net_nn_fc_5, net_nn_fc_6, net_nn_fc_7,
                               net_nn_fc_8, net_nn_fc_9, net_nn_fc_10, net_nn_fc_10_0, net_nn_fc_10_2,
                               net_nn_fc_10_3e, net_nn_fc_10_3e_mask,
                               net_nn_fc_11, net_nn_fc_12, net_nn_fc_13, net_nn_fc_14,
                               net_nn_dec)
...
net_models = {
    ...
    'fc9': net_nn_fc_9,
    'fc10': net_nn_fc_10,
    'fc10_0': net_nn_fc_10_0,
    'fc10_2': net_nn_fc_10_2,
...
class PPO(object):
    ...
    def evaluate(self, s1, s2,
        ...
        with torch.no_grad():
            ...
            if deterministic:
                action_with_highest_probality = self.actor.dist_mode(s1, s2)
                choosed_action = action_with_highest_probality
            else:
                dist, alpha, beta = self.actor.get_dist(s1, s2)
    ...
    def train(self, global_step, epoches=None, anneal_mode='exponential'):
        ...
        if self.anneal_lr:
            ...
            if anneal_mode == 'exponential':
                frac = 0.99 ** (global_step / self.totoal_steps * 1000)
