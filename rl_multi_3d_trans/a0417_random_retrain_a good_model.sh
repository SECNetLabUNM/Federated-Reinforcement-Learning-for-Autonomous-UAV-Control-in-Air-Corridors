#!/bin/bash
# used for training /mnt/storage/result/d2move_20240325092534_new_net/width_128epoch4_index_True_state2_cbfFalse_acc0.3_future2_shareTrue_netfc10_horizon8_batch16_enc2_dec2_spaceTrue_level20_capacity6_beta_base1.0_beta_adaptor_coefficient1.1
# with new release rule
...
param18_values=( 'True')  # state choice
                ...
                for param8 in "${param8_values[@]}"; do
                  for param9 in "${param9_values[@]}"; do
                    for param10 in "${param10_values[@]}"; do
                      ...
                      gpu_index=1 # Set default GPU index

                      # Construct experiment name
                      exp_name="new_net:width_${param15}epoch${param19}_index_${param16}_state${param17}_corindex${param18}_acc${param14}_future${param13}_share${param10}_net${param9}_horizon${param2}_batch${param3}_enc${param6}_dec${param7}_space${param5}_level${param8}_capacity${param1}_beta_base${param11}_beta_adaptor_coefficient${param12}"
                      echo $PATH
                      # Run the Python script with parameters
                      CUDA_VISIBLE_DEVICES=$gpu_index python /home/kun/PycharmProjects/air-corridor_ncfo/rl_multi_3d_trans/main.py \
                          --seed 35 \
                          --LoadFolder /mnt/storage/result/d2move_20240416110709_new_net/width_128epoch4_index_True_state2_corindexTrue_acc0.3_future2_shareTrue_netfc10_horizon8_batch16_enc2_dec2_spaceTrue_level20_capacity12_beta_base1.0_beta_adaptor_coefficient1.1 \
                          --LoadModel True \
                          --variable_agent True\
                          --ModelIndex 2.15e7 \
                          --time ${current_time} \
