...
# NOTE: Took parameters from num1,train4 of trained models
...
parser.add_argument('--multiply_horrizion', type=int, default=5, help='Share feature extraction layers?')
parser.add_argument('--multiply_batch', type=int, default=10, help='Share feature extraction layers?')
