...
param7_values=(3) # num of decoder
param8_values=( 15) #reset level;     level 2: random 1 piece;   level 3: random 2 pieces; level 13: random 3 pieces;
param9_values=('dec') # network model
                ...
                for param8 in "${param8_values[@]}"; do
                  for param9 in "${param9_values[@]}"; do
                    for param10 in "${param10_values[@]}"; do
                      ...
                      exp_name="new_net:dec_${param7}_width_${param15}epoch${param19}_corindex${param18}_net${param9}_horizon${param2}_level${param8}_capacity${param1}_beta_adaptor${param12}"
                      echo $PATH
