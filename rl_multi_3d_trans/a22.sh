...
param1_values=(12) # num of agents
param2_values=(8)
param3_values=(16)
...
param8_values=( 16 ) #reset level;     level 2: random 1 piece;   level 3: random 2 pieces; level 13: random 3 pieces;
param9_values=( 'fc10_2' 'fc11') # network model
