...
param8_values=( 19 20) #reset level;     level 2: random 1 piece;   level 3: random 2 pieces; level 13: random 3 pieces;
                  ...
                  for param9 in "${param9_values[@]}"; do
                    for param10 in "${param10_values[@]}"; do
                      ...
                      CUDA_VISIBLE_DEVICES=$gpu_index python /home/kun/PycharmProjects/air-corridor_ncfo/rl_multi_3d_trans/main.py \
                          --seed 55 \
                          --LoadModel True \
                          --LoadFolder '/mnt/storage/result/d2move_20240428183832_new_net/width_128epoch4_corindexTrue_netfc10_3e_horizon8_level19_capacity4_beta_adaptor1.1' \
                          --ModelIndex 1.9e7 \
