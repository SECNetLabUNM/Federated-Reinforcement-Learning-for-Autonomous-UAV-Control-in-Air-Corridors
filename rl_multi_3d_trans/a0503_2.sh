...
param11_values=(1e-5 1e-6 1e-7)  # beta base
                ...
                for param8 in "${param8_values[@]}"; do
                  for param9 in "${param9_values[@]}"; do
                    for param10 in "${param10_values[@]}"; do
                      ...
                      exp_name="new_net:${param17}_${param18}_${param19}_${param11}_${param12}_model_${param9}_horizon${param2}_level${param8}_capacity${param1}"
                      echo $PATH
